...
AddEventHandler('esx_vehicleshop:setVehicleOwned', function (vehicleProps,vhlabel,vhbrand)
  local _source = source
  local xPlayer = ESX.GetPlayerFromId(source)
  local modellabel = vhlabel
  local brandlabel = vhbrand

  MySQL.Async.execute(
    'INSERT INTO owned_vehicles (vehicle, owner, plate, modelname,brand) VALUES (@vehicle, @owner, @plate, @modelname,@brand)',
    {
...
AddEventHandler('esx_vehicleshop:setVehicleOwnedPlayerId', function (playerId, vehicleProps,vhlabel,vhbrand)
  local xPlayer = ESX.GetPlayerFromId(playerId)
  local modelname = vhlabel
  local brandlabel = vhbrand

  MySQL.Async.execute(
    'INSERT INTO owned_vehicles (vehicle, owner, modelname,plate,brand) VALUES (@vehicle, @owner, @modelname,@plate,@brand)',
    {
      ['@vehicle'] = json.encode(vehicleProps),
      ['@owner']   = xPlayer.identifier,
      ['@modelname'] = modelname,
